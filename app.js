...
async function loadAdminMessages(scroll=true){
  ...
  $('#supportStatus').value=conversation.status;$('#supportStatus').onchange=event=>setAdminChatStatus(event.target.value);$('#supportReply').onsubmit=sendAdminReply;if(scroll){const box=$('#supportMessages');box.scrollTop=box.scrollHeight}
}
