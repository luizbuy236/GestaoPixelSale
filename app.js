...
async function loadAdminMessages(scroll=true){
  ...
  if(!scroll&&currentMessages){const keepAtBottom=currentMessages.scrollHeight-currentMessages.scrollTop-currentMessages.clientHeight<80;currentMessages.innerHTML=messagesHtml;if(keepAtBottom)currentMessages.scrollTop=currentMessages.scrollHeight;return}
